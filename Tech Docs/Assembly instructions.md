...
Connect the ESP8266 with the rightmost display. you can use a PCB <https://github.com/rvangelder11/Big-Digital-clock-with-5-inch-displays/tree/main/PCB> for that, but you could also use individual Female-Female Dupont wires:
